...
def main(page: ft.Page):
    ...
    page.drawer = get_main_drawer(
        on_drawer_el_selected=drawer_element_selected
    )
    ...
    def change_screen(target: str):
        ...
        if target == "login":
            ...
            if users_list:
                ...
                show_content_after_loading(get_error_col(page, "Список учеников пуст", disable_scroll=True, icon_filename='student.png'))
