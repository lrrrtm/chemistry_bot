...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-[var(--color-background)] p-6 shadow-lg rounded-lg mx-4 max-w-[calc(100%-2rem)] sm:max-w-lg",
        className
      )}
      {...props}
    />
